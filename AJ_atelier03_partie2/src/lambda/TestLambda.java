...
public class TestLambda {
    ...
    public static void main(String[] args) {
        ...
        List<String> result2 = Lambda.filter(list2,s -> s.toString().startsWith("h"));
        System.out.println(result2);

        //Retournerune liste qui contient la taille de chacune des String de la liste originale
       List<Integer> result3 = Lambda.map(list2,nb -> nb.length());
